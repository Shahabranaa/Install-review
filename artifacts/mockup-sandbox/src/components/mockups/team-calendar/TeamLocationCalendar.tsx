...
// ── Real data from DB for 2026-07-31 ─────────────────────────────────────────

const REAL_DATE = new Date(2026, 6, 31); // July 31 2026
...
const ALL_LOCATIONS = [
  ...
  "A01","A02","A03","OSS East","OSS West","Vessel",
];
...
// dayIdx 0 = July 31 (the seeded date)
const SEED: Assignments = {
  "1-0": [
    { id:"r01", location:"At-Sea",  scope:"Effective Working Time", stage:"captured" },
    { id:"r02", location:"BLP 69",  scope:"Effective Working Time", stage:"captured" },
    { id:"r03", location:"BLP 51",  scope:"Effective Working Time", stage:"draft"    },
    { id:"r04", location:"A01",     scope:"Effective Working Time", stage:"draft"    },
    { id:"r05", location:"A02",     scope:"Re-Work",                stage:"draft"    },
  ],
  "2-0": [
    { id:"r11", location:"BLP 69",  scope:"Effective Working Time", stage:"draft"    },
    { id:"r12", location:"At-Sea",  scope:"Effective Working Time", stage:"draft"    },
    { id:"r13", location:"BLP 51",  scope:"Effective Working Time", stage:"draft"    },
    { id:"r14", location:"Vessel",  scope:"Extra Work",             stage:"draft"    },
  ],
  "3-0": [
    { id:"r21", location:"A03",      scope:"Effective Working Time", stage:"draft"   },
    { id:"r22", location:"At-Sea",   scope:"Effective Working Time", stage:"draft"   },
    { id:"r23", location:"OSS East", scope:"Effective Working Time", stage:"draft"   },
  ],
  "4-0": [
    { id:"r31", location:"A01",      scope:"Effective Working Time", stage:"captured" },
    { id:"r32", location:"At-Sea",   scope:"Effective Working Time", stage:"draft"    },
    { id:"r33", location:"OSS East", scope:"Effective Working Time", stage:"draft"    },
  ],
  "5-0": [
    { id:"r41", location:"At-Sea",   scope:"Effective Working Time", stage:"draft"   },
    { id:"r42", location:"OSS West", scope:"Effective Working Time", stage:"draft"   },
  ],
  "6-0": [
    { id:"r51", location:"At-Sea",   scope:"Effective Working Time", stage:"draft"   },
    { id:"r52", location:"OSS West", scope:"Effective Working Time", stage:"draft"   },
  ],
  "7-0": [
    { id:"r61", location:"At-Sea",   scope:"Effective Working Time", stage:"draft"   },
    { id:"r62", location:"BLP 52",   scope:"Effective Working Time", stage:"draft"   },
  ],
  "8-0": [
    { id:"r71", location:"At-Sea",   scope:"Effective Working Time", stage:"draft"   },
    { id:"r72", location:"BLP 52",   scope:"Effective Working Time", stage:"draft"   },
  ],
  "9-0": [
    { id:"r81", location:"At-Sea",   scope:"Effective Working Time", stage:"draft"   },
    { id:"r82", location:"BLP 50",   scope:"Effective Working Time", stage:"draft"   },
  ],
};
    ...
    <div style={{ display:"flex", height:"100vh", fontFamily:"'Inter', system-ui, sans-serif", background:"#fff", color:"#1c2738", overflow:"hidden" }}>
      ...
      <div style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden", minWidth:0 }}>
        ...
        <div style={{ borderBottom:"1px solid #d3dbe8", background:"#fff", padding:"8px 12px", display:"flex", alignItems:"center", gap:8, flexShrink:0 }}>
          ...
          <span style={{ fontWeight:600, fontSize:13, color:"#1c2738" }}>Thu, Jul 31</span>
          {/* "real data" badge */}
          <span style={{ fontSize:10, background:"#dcfce7", color:"#15803d", border:"1px solid #86efac", padding:"2px 8px", borderRadius:10, fontWeight:600 }}>Live data · 2026-07-31</span>
              ...
              <div style={{ minWidth:"max-content" }}>
                ...
                <div style={{ display:"flex", position:"sticky", top:0, zIndex:10 }}>
                  ...
                  {days.map((d, i) => {
                    const highlight = i === 0;
                    return (
                      <div key={i} style={{ width:160, flexShrink:0, borderRight:"1px solid #d3dbe8", borderBottom:"1px solid #d3dbe8", padding:"8px 10px", background: highlight ? "#eff6ff" : "#fff", display:"flex", flexDirection:"column", gap:2 }}>
                        <div style={{ display:"flex", alignItems:"center", gap:6 }}>
                          <span style={{ fontSize:11, fontWeight:700, textTransform:"uppercase", letterSpacing:"0.04em", color: highlight ? "#1470cc" : "#7a8ba3" }}>{DOW[d.getDay()]}</span>
                          ...
                          {!highlight && <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#d3dbe8" strokeWidth="2"><path d="M9 18l6-6-6-6"/></svg>}
                        </div>
                        <span style={{ fontSize:11, color: highlight ? "#1470cc" : "#7a8ba3", fontWeight: highlight ? 500 : 400 }}>{MONTH[d.getMonth()]} {d.getDate()}</span>
                      </div>
                    );
                  })}
                </div>
