...
const migrations = [
  ...
  (23, 'Electrical - Termination', 'Effective Working Time', 'HV Termination', 'EWT', NULL, 7),
  ...
  (27, 'Electrical - Termination', 'Effective Working Time', 'HV Termination', 'EWT', NULL, 7),
  ...
  (31, 'Electrical - Termination', 'Effective Working Time', 'HV Termination', 'EWT', NULL, 7),
  (32, 'Electrical - Termination', 'Effective Working Time', 'HV Termination', 'EWT', '-Temporary Caps Installed ready for Plug-In', 7),
  (33, 'Electrical - Termination', 'Effective Working Time', 'HV Termination', 'EWT', NULL, 7),
  ...
  (55, 'TBT / POWRA', 'Effective Working Time', 'HSE - Toolbox Talk', 'EWT', NULL, 13),
  ...
  (58, 'ORS TBC', 'Effective Working Time', 'Other - (Refer to Comments)', 'EWT', NULL, NULL),
  (59, 'Other (CDT)', 'Effective Working Time', 'Waiting on Team Member/s', 'EWT', NULL, NULL),
  (60, 'Waiting on material, equipment or documentation (CDT)', 'Non-Working Time', 'Waiting on Material/Equipment', 'EWT', NULL, 23),
  ...
  (64, 'Transit to/from field', 'Non-Working Time', 'Port Call (Excluding Transit)', 'NWT', NULL, 15),
  ...
  (67, 'Transit to/from field', 'Non-Working Time', 'Transit – Offshore Personnel Transfer', 'NWT', NULL, 15),
  ...
  (70, 'Standby (EDT) - Waiting on Transfer / No Work Location Available', 'Non-Working Time', 'Work Location Not Available', 'NWT', NULL, 18),
  ...
  (74, 'Standby (EDT) - Other', 'Non-Working Time', 'Other - (Refer to Comments)', 'NWT', NULL, 20),
  ...
  (78, 'Standby (EDT) - Other', 'Non-Working Time', 'Waiting on Access', 'NWT', NULL, 20),
  (79, 'Standby (EDT) - Other', 'Non-Working Time', 'Waiting on Site Services / Infrastructure', 'NWT', NULL, 20),
  (80, 'Standby (EDT) - Other', 'Non-Working Time', 'Waiting on SAPs / Electrical Safety Docs', 'NWT', NULL, 20),
  (81, 'Standby (EDT) - Other', 'Non-Working Time', 'Waiting on OCS SWG De-Gassing', 'NWT', NULL, 20),
  ...
  (87, 'Waiting on material, equipment or documentation (EDT)', 'Non-Working Time', 'Waiting on Material/Equipment', 'NWT', NULL, NULL),
  (88, 'Standby (EDT) - Other', 'Non-Working Time', 'Other - (Refer to Comments)', 'NWT', NULL, 20),
  (89, 'ORS TBC', 'Non-Working Time', 'Client Downtime', 'NWT', NULL, NULL),
