...
export const approveImage = async (
  id: number,
  approveImageBody: ApproveImageBody,
  options?: RequestInit,
): Promise<ImageRecord> => {
  return customFetch<ImageRecord>(getApproveImageUrl(id), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(approveImageBody),
  });
};

export const getApproveImageMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type ApproveImageMutationResult = NonNullable<
  Awaited<ReturnType<typeof approveImage>>
>;
...
export const rejectImage = async (
  id: number,
  rejectImageBody: RejectImageBody,
  options?: RequestInit,
): Promise<ImageRecord> => {
  return customFetch<ImageRecord>(getRejectImageUrl(id), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(rejectImageBody),
  });
};

export const getRejectImageMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type RejectImageMutationResult = NonNullable<
  Awaited<ReturnType<typeof rejectImage>>
>;
...
export const getGetPhaseStatusesUrl = (params?: GetPhaseStatusesParams) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/dashboard/phase-statuses?${stringifiedParams}`
    : `/api/dashboard/phase-statuses`;
};

export const getPhaseStatuses = async (
  params?: GetPhaseStatusesParams,
  options?: RequestInit,
): Promise<PhaseStatusBreakdown> => {
...
export const getGetPhaseStatusesQueryKey = (
  params?: GetPhaseStatusesParams,
) => {
  return [
    `/api/dashboard/phase-statuses`,
...
export const getGetPhaseStatusesQueryOptions = <
  TData = Awaited<ReturnType<typeof getPhaseStatuses>>,
  TError = ErrorType<unknown>,
>(
  params?: GetPhaseStatusesParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getPhaseStatuses>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetPhaseStatusesQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getPhaseStatuses>>
  > = ({ signal }) => getPhaseStatuses(params, { signal, ...requestOptions });
...
export type GetPhaseStatusesQueryResult = NonNullable<
  Awaited<ReturnType<typeof getPhaseStatuses>>
>;
...
export function useGetPhaseStatuses<
  TData = Awaited<ReturnType<typeof getPhaseStatuses>>,
  TError = ErrorType<unknown>,
>(
  params?: GetPhaseStatusesParams,
